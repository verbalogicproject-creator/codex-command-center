...
POSTGRES_HANDOFF_VISUAL_COMPARISON_MIGRATION_V7 = """
ALTER TABLE handoffs
  ADD COLUMN IF NOT EXISTS visual_brief_json TEXT NOT NULL DEFAULT '{}';
"""

POSTGRES_ARIA_COMMAND_CENTER_MIGRATION_V8 = """
ALTER TABLE turns ADD COLUMN IF NOT EXISTS modality TEXT NOT NULL DEFAULT 'text'
  CHECK(modality IN ('text','voice'));
ALTER TABLE turns ADD COLUMN IF NOT EXISTS metadata_json TEXT NOT NULL DEFAULT '{}';
...
CREATE TABLE IF NOT EXISTS aria_profiles(
  ...
  created_at TEXT NOT NULL,
  updated_at TEXT NOT NULL);
CREATE UNIQUE INDEX IF NOT EXISTS idx_aria_profile_name_normalized
  ON aria_profiles(LOWER(name));
...
POSTGRES_MULTI_PROJECT_CONTROL_PLANE_MIGRATION_V9 = """
ALTER TABLE handoffs
  ADD COLUMN IF NOT EXISTS source_repositories_json TEXT NOT NULL DEFAULT '[]';
ALTER TABLE handoffs
  ADD COLUMN IF NOT EXISTS selected_evidence_ids_json TEXT NOT NULL DEFAULT '[]';
ALTER TABLE handoffs
  ADD COLUMN IF NOT EXISTS composition_json TEXT NOT NULL DEFAULT '{}';
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS repository TEXT;
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS goal TEXT NOT NULL DEFAULT '';
...
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS revision TEXT;
...
POSTGRES_APP_MIGRATIONS = {
    ...
    7: POSTGRES_HANDOFF_VISUAL_COMPARISON_MIGRATION_V7,
    8: POSTGRES_ARIA_COMMAND_CENTER_MIGRATION_V8,
    9: POSTGRES_MULTI_PROJECT_CONTROL_PLANE_MIGRATION_V9,
}
